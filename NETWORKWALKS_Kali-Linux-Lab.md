...
Snapshot Name:  Networkkwalks - IP Configuration Complete and, to show evidence screenshots will be added to document.
   ...
   Conclusion:
Kali Linux virtual machine was successfully configured on a private NAT Network, where the VM received the IP address 10.0.0.3/24, used 10.0.0.1 as its default gateway, successfully connected to t[...]
